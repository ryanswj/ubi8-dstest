...
COPY certs/Certificates_PKCS7_v5.7_DoD.pem.p7b /
...
RUN echo Update packages and install DISA STIG fixes && \
    ...
    openssl pkcs7 -print_certs -in Certificates_PKCS7_v5.7_DoD.pem.p7b -out "/etc/pki/ca-trust/source/anchors/Certificates_PKCS7_v5.7_DoD.pem && \
    update-ca-trust && \
    update-ca-trust force-enable && \
    rm Certificates_PKCS7_v5.7_DoD.pem.p7b && \
    dnf clean all && \
